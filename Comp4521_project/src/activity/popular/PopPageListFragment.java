...
public class PopPageListFragment extends ListFragment
{
	private static final String TAG = "PopPageList";
	...
	@Override
	  public void onActivityCreated(Bundle savedInstanceState) {
	   ...
	   //wangbo replace the test instance
	    ...
	    BookViewAdaptor adapter = new BookViewAdaptor(getActivity(), mkbookviewlist.bookViewArray2);
